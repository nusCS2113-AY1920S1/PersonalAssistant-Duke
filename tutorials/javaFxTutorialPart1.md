...
Next, we create another Java class, `controlpanel.Launcher`, as an entry point to our application.
The `controlpanel.Launcher` class is reproduced below in its entirety.
 ...
 */
public class controlpanel.Launcher {
    public static void main(String[] args) {
        Application.launch(controlpanel.FG.class, args);
    }
}
```

Run `controlpanel.Launcher` and you should see something like this:
