# JavaFX Tutorial Part 2 - Creating a GUI for mistermusik.Main

In this tutorial, we will be creating a GUI for mistermusik.Main from scratch based on the following mockup.

![Mockup for mistermusik.Main](assets/DukeMockup.png)
...
![mistermusik.Main's layout](assets/DukeSceneGraph.png) 
...
![mistermusik.Main's raw layout](assets/RawLayout.png)
...
```java
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("mistermusik.Main");
...
![mistermusik.Main's Final layout](assets/FinalLayout.png)
