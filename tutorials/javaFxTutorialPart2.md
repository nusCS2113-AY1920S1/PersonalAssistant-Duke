# JavaFX Tutorial Part 2 - Creating a GUI for logic.Duke

In this tutorial, we will be creating a GUI for logic.Duke from scratch based on the following mockup.

![Mockup for logic.Duke](assets/DukeMockup.png)
...
![logic.Duke's layout](assets/DukeSceneGraph.png) 
...
![logic.Duke's raw layout](assets/RawLayout.png)
...
![logic.Duke's Final layout](assets/FinalLayout.png)
