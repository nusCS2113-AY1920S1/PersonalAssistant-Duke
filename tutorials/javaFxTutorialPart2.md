# JavaFX Tutorial Part 2 - Creating a GUI for duke.Ducats

In this tutorial, we will be creating a GUI for duke.Ducats from scratch based on the following mockup.

![Mockup for duke.Ducats](assets/DukeMockup.png)
...
![duke.Ducats's layout](assets/DukeSceneGraph.png) 
...
public class duke.Ducats extends Application {
...
![duke.Ducats's raw layout](assets/RawLayout.png)
...
![duke.Ducats's Final layout](assets/FinalLayout.png)
