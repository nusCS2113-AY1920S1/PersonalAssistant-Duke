# JavaFX Tutorial Part 2 - Creating a GUI for controlpanel.FG

In this tutorial, we will be creating a GUI for controlpanel.FG from scratch based on the following mockup.

![Mockup for controlpanel.FG](assets/DukeMockup.png)
...
![controlpanel.FG's layout](assets/DukeSceneGraph.png) 
...
![controlpanel.FG's raw layout](assets/RawLayout.png)
...
```java
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("controlpanel.FG");
...
![controlpanel.FG's Final layout](assets/FinalLayout.png)
