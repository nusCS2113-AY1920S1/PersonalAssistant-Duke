# JavaFX Tutorial Part 2 - Creating a GUI for duke.logic.Duke

In this tutorial, we will be creating a GUI for duke.logic.Duke from scratch based on the following mockup.

![Mockup for duke.logic.Duke](assets/DukeMockup.png)
...
![duke.logic.Duke's layout](assets/DukeSceneGraph.png) 
...
![duke.logic.Duke's raw layout](assets/RawLayout.png)
...
```java
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("duke.logic.Duke");
...
![duke.logic.Duke's Final layout](assets/FinalLayout.png)
