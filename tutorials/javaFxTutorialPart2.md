# JavaFX Tutorial Part 2 - Creating a GUI for javacake

In this tutorial, we will be creating a GUI for javacake from scratch based on the following mockup.

![Mockup for javacake](assets/DukeMockup.png)
...
![javacake's layout](assets/DukeSceneGraph.png) 
...
![javacake's raw layout](assets/RawLayout.png)
...
![javacake's Final layout](assets/FinalLayout.png)
