...
public class Duke extends Application {
    ...
    private Image dolla = new Image(this.getClass().getResourceAsStream("/images/DaDuke.png"));
    // ...
}
```
...
private void handleUserInput() {
    ...
    dialogContainer.getChildren().addAll(
            ...
            new DialogBox(dukeText, new ImageView(dolla))
    );
    userInput.clear();
}
...
private void handleUserInput() {
    ...
    dialogContainer.getChildren().addAll(
            ...
            DialogBox.getDukeDialog(dukeText, new ImageView(dolla))
    );
    userInput.clear();
}
```
