...
public class Duke extends Application {
    ...
    private Image sgtravel = new Image(this.getClass().getResourceAsStream("/images/DaDuke.png"));
    // ...
}
```
...
private void handleUserInput() {
    ...
    dialogContainer.getChildren().addAll(
            ...
            new DialogBox(dukeText, new ImageView(sgtravel))
    );
    userInput.clear();
}
...
private void handleUserInput() {
    ...
    dialogContainer.getChildren().addAll(
            ...
            DialogBox.getDukeDialog(dukeText, new ImageView(sgtravel))
    );
    userInput.clear();
}
```
