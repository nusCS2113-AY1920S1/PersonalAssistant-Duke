...
**Say goodbye to piles of paper records.** Eggventory allows you to quickly and conveniently view all your stock and loan records. With the colour-based status indicator, **hours spent slicing through inventory data can be cut down into seconds.** As students, *we care* - so that you won't have to stay back after 5pm to account for our lab logistics anymore!
