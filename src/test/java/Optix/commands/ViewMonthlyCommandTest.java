...
class ViewMonthlyCommandTest {
    ...
    @Test
    void execute() {
        AddCommand addDummyShow = new AddCommand("dummy show name", "5/5/2020", 20);
        addDummyShow.execute(model, ui, storage);

        SellSeatCommand sellDummySeat = new SellSeatCommand("dummy show name", "5/5/2020",
                "A1 A2 A3");
        sellDummySeat.execute(model, ui, storage);

        AddCommand addDummyShow2 = new AddCommand("dummy show name2", "20/5/2020", 20);
        addDummyShow2.execute(model, ui, storage);

        SellSeatCommand sellDummySeat2 = new SellSeatCommand("dummy show name2", "20/5/2020",
                "A1 A2 A3 A4 A5");
        sellDummySeat2.execute(model, ui, storage);

        AddCommand addDummyShow3 = new AddCommand("dummy show name3", "1/1/2030", 20);
        addDummyShow3.execute(model, ui, storage);

        SellSeatCommand sellDummySeat3 = new SellSeatCommand("dummy show name3", "1/1/2030",
                "A1 A2 A3 B2");
