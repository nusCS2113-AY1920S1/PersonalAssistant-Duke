...
public class ParserTest {
    ...
    public void parseDeletePatient() throws DukeException {
        ...
        assertTrue(testOutputID.charAt(0) == '#' && testOutputID.equals("#123"), "Delete patient by ID parsing failed. Expected '#123' but got: " + testOutputID);
        assertTrue(testOutputName.equals("billy joe"), "Delete patient by name parsing failed. Expected 'billy joe' but got: " + testOutputName);
    }
    ...
    public void parseDeleteTask() throws DukeException {
        ...
        assertTrue(testOutputID.charAt(0) == '#' && testOutputID.equals("#10"), "Delete task by ID parsing failed. Expected '#10' but got: " + testOutputID);
        assertTrue(testOutputName.equals("Take medicine"), "Delete task by name parsing failed. Expected 'Take medicine' but got: " + testOutputName);
    }
