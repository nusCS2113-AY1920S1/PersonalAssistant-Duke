...
class ShowItineraryCommandTest {
    ...
    void execute() throws DukeException, FileNotFoundException {
        ...
        ShowItineraryCommand showItineraryCommand = new ShowItineraryCommand("Test");
        showItineraryCommand.execute(model);

        CommandResultText commandResult = showItineraryCommand.execute(model);
