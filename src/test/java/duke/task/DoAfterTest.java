...
public class DoAfterTest {
    ...
    void doAfterTodoTest() throws ParseException {
        ...
        assertEquals("[A][✗] After Todo (Do after: Todo Task)", doAftertask.toString());
    }
    ...
    void doAfterEventTest() throws ParseException {
        ...
        assertEquals("[A][✗] After Event (Do after: Event Task)", doAftertask.toString());
    }
    ...
    void doAfterDeadlineTest() throws ParseException {
        ...
        assertEquals("[A][✗] After Deadline (Do after: Deadline Task)", doAftertask.toString());
    }
}
