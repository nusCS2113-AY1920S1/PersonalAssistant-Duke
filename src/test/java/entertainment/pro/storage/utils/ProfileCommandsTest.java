...
public class ProfileCommandsTest {
    ...
    @Test
    public void addPreferenceTest_valid_sort_input() throws InvalidFormatCommandException {
    ...
    @Test
    public void addPreferenceTest_valid_adult_input() throws InvalidFormatCommandException {
        TreeMap<String, ArrayList<String>> flagMap = new TreeMap<>();
    ...
    @Test
    public void clearPreferenceTest_valid_sort_input() throws InvalidFormatCommandException {
        TreeMap<String, ArrayList<String>> flagMap = new TreeMap<>();
        ArrayList<String> sortOption = new ArrayList<>();
        flagMap.put("-s", sortOption);
        try {
