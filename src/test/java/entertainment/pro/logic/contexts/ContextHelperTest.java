...
public class ContextHelperTest {
    ...
    public void getLastIncompleteWords_validInputs_success() {
        String incomplete = ContextHelper.getLastIncompleteWords("search movies Harry potter and the order",
                new MovieHandler());
    ...
    public void completeCommand_validIndex_success() {
        ...
        ArrayList<String> possibilities = new ArrayList<String>(Arrays.asList(
                "hello world", "hello guys", "hello girls"));
        assertEquals("ello", ContextHelper.completeCommand(possibilities, "h"));

        ArrayList<String> possibilities1 = new ArrayList<String>(Arrays.asList("batman and jobbin", "batman and joker",
                "batman and jennifer"));
    ...
    public void completeCommand_invalidIndex_failure() {
        ...
        ArrayList<String> possibilities1 = new ArrayList<String>(Arrays.asList(
                "jobbin", "mobbin", "batman and jennifer"));
