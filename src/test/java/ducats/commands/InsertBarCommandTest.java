...
public class InsertBarCommandTest {
    ...
    public void execute_normalInput_success() throws DucatsException {
        ...
        InsertBarCommand insertBarTest2 = new InsertBarCommand("insertbar bar:2 1_LD");
        ...
        InsertBarCommand insertBarTest3 = new InsertBarCommand("insertbar bar:1 1_LE");
    ...
    public void execute_invalidBarNum_exceptionThrown() throws DucatsException {
        InsertBarCommand newTest4 = new InsertBarCommand("insertbar bar:random 2_MC 2_MC");
        ...
        DucatsException expectedDucatsException4 = new DucatsException("insertbar:random 2_MC 2_MC", "insertbar");
        assertEquals(expectedDucatsException4.getMessage(), testDucatsException4.getMessage());

        InsertBarCommand newTest5 = new InsertBarCommand("insertbar bar:!@#$%^ 2_MC 2_MC");
        ...
        DucatsException expectedDucatsException5 = new DucatsException("insertbar bar:!@#$%^ 2_MC 2_MC", "insertbar");
        assertEquals(expectedDucatsException5.getMessage(), testDucatsException5.getMessage());

        InsertBarCommand newTest6 = new InsertBarCommand("insertbar bar: 2_MC 2_MC");
        ...
        DucatsException expectedDucatsException6 = new DucatsException("insertbar bar: 2_MC 2_MC", "insertbar");
        assertEquals(expectedDucatsException6.getMessage(), testDucatsException6.getMessage());

        InsertBarCommand newTest7 = new InsertBarCommand("insertbar bar:0 2_MC 2_MC");
        ...
        DucatsException expectedDucatsException7 = new DucatsException("insertbar bar:0 2_MC 2_MC", "insertbar");
        assertEquals(expectedDucatsException7.getMessage(), testDucatsException7.getMessage());

        InsertBarCommand newTest8 = new InsertBarCommand("insertbar bar:-1 2_MC 2_MC");
        ...
        DucatsException expectedDucatsException8 = new DucatsException("insertbar bar:-1 2_MC 2_MC", "insertbar");
        assertEquals(expectedDucatsException8.getMessage(), testDucatsException8.getMessage());

        InsertBarCommand newTest9 = new InsertBarCommand("insertbar bar:4 2_MC 2_MC");
        ...
        DucatsException expectedDucatsException9 = new DucatsException("insertbar bar:4 2_MC 2_MC", "insertbar");
    ...
    public void execute_invalidBarContent_exceptionThrown() throws DucatsException {
        InsertBarCommand newTest10 = new InsertBarCommand("insertbar bar:1 2_MC 4_MC");
        ...
        DucatsException expectedDucatsException10 = new DucatsException("insertbar bar:1 2_MC 4_MC", "insertbar");
        assertEquals(expectedDucatsException10.getMessage(), testDucatsException10.getMessage());

        InsertBarCommand newTest11 = new InsertBarCommand("insertbar bar:1 2_UA 4_MC 8_LC 16_LF 16_LD");
        ...
        DucatsException expectedDucatsException11 = new DucatsException("insertbar bar:1 2_UA 4_MC 8_LC 16_LF 16_LD",
                "insertbar");
        assertEquals(expectedDucatsException11.getMessage(), testDucatsException11.getMessage());

        InsertBarCommand newTest12 = new InsertBarCommand("insertbar bar:1 ");
