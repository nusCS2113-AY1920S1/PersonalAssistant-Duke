...
public class OverlayGroupGroupFail {
    ...
    public void testGroupGroup() {
        ...
        String expected = "{UPPER_A }{UPPER_A }{UPPER_A }{UPPER_A }|" +
                ...
                "{UPPER_A }{UPPER_A }{UPPER_A }{UPPER_A }|";
        */
        String expected = "{UPPER_A UPPER_E UPPER_A }{UPPER_A UPPER_E UPPER_A }"
                + "{UPPER_A UPPER_E UPPER_A }{UPPER_A UPPER_E UPPER_A }|"
                + "{UPPER_E UPPER_A MIDDLE_C UPPER_E }{UPPER_E UPPER_A MIDDLE_C UPPER_E }"
                + "{UPPER_E UPPER_A MIDDLE_C UPPER_E }{UPPER_E UPPER_A MIDDLE_C UPPER_E }|"
                + "{MIDDLE_C UPPER_E UPPER_A }{MIDDLE_C UPPER_E UPPER_A }{MIDDLE_C UPPER_E UPPER_A }"
                + "{MIDDLE_C UPPER_E UPPER_A }|"
