...
public class GroupCommandTest {
    ...
    public void testGroupCommmand_validInput_success() {
        ...
        String expectedResult = "[test [[UAs],[UA],[UCs],[UC],[LBs],[LB],[LAs],[LA]] [[UFs],[UF],[UEs],[UE],[UDs],[UD],[LGs],[LG]] ]";
    ...
    /**
     * the isExit() method of this class must always return false
     */
    @Test
    public void isExit_noInput_returnsFalse(){
        GroupCommand groupCommand = new GroupCommand("group 1 30 test");
        assertEquals(false, groupCommand.isExit());
    }
    //@@author rohan-av
    @Test
