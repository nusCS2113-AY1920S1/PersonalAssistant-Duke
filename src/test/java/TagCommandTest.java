...
public class TagCommandTest {
    ...
    @Test
    void testTagCommandTest() throws DukeException, ParseException, IOException {
        ...
        tasks.add(td);
        tasks.add(dl);
        tc.execute(tasks, ui, storage, commandStack, deletedTask, triviaManager);

        assertEquals("Here are the matching tags in your list:\r\n"
                + "1.[E][ND]meeting #school(at:12 Dec 2019 03:03:03-04:04:04)\r\n"
                + "2.[T][ND] go to lecture #school\r\n"
                + "3.[D][ND] project #school(by:04 Mar 2019 12:12:12)\r\n", output.toString());
    }
