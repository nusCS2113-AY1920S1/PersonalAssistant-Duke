...
public class ReminderCommandTest {
    private final String duchessErrorMessage = "Please enter a valid command.";
    private final Storage storage = new Storage("text_file");
    private final Store store = new Store();
    private final Ui ui = new Ui();

    @Test
    public void execute_withoutDeadlines_success() {
        try {
            ...
            assertEquals(e.getMessage(), duchessErrorMessage);
        }
    }

    @Test
    public void execute_withDeadlines_success() {
