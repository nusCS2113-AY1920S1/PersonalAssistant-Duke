...
public class ViewHelperTest {
    ...
    void consolePrintTableHoriBorderTest() {
        ...
        String actualOutput = viewHelper.consolePrintTableHoriBorder(60);
    ...
    void getArrayOfSplitStringsTest() {
        ...
        String[] expectedOutput = new String[] {" 1. A very very very long name (Phone: 12345678901234567890 ",
            "| Email: alonglonglongemailaddress@gmail.com | Role: member)"};
        ...
        String[] expectedOutput2 = new String[] {" 3. ", "aVeryVeryVeryVeryVeryVeryVeryVeryVeryVeryVeryVeryLongNameWi-",
            "thoutSpace (Phone: -- | Email: -- | Role: member)"};
        ...
        String[] expectedOutput3 = new String[] {" 4. A very very very very very very very very very very     ",
            "very very very very very very very very very very very very ",
            "very long text (Phone: -- | Email: -- | Role: member)"};
