...
class TaskListTest {
    ...
    void testGetAllTaskDetails() {
        ...
        assertEquals(testRemoveTaskListString,taskList.getAllTaskDetails(project.getTasksAndAssignedMembers()).toString());
    }
    ...
    void testGetAllSortedTaskDetails() {
        ...
        try {
            ...
            String testPriorityTaskListString = "["
                    ...
                    + "]";
            assertEquals(testPriorityTaskListString,taskList.getAllSortedTaskDetails(project.getTasksAndAssignedMembers(),"/PRIORITY").toString());
            ...
            String testNameTaskListString = "["
                    ...
                    + " | Credit: 90 | State: DONE"
                    + "]";
            assertEquals(testNameTaskListString,taskList.getAllSortedTaskDetails(project.getTasksAndAssignedMembers(),"/NAME").toString());
            ...
            String testDueDateTaskListString = "["
                    ...
                    + " | Credit: 80 | State: OPEN"
                    + "]";
            assertEquals(testDueDateTaskListString,taskList.getAllSortedTaskDetails(project.getTasksAndAssignedMembers(),"/DATE").toString());
            ...
            String testCreditTaskListString = "["
                    ...
                    + "]";
            assertEquals(testCreditTaskListString,taskList.getAllSortedTaskDetails(project.getTasksAndAssignedMembers(),"/CREDIT").toString());
            ...
            String testKanbanTaskListString = "["
                    ...
                    + " | Credit: 70 | State: DONE"
                    + "]";
            assertEquals(testKanbanTaskListString,taskList.getAllSortedTaskDetails(project.getTasksAndAssignedMembers(),"/KANBAN-DONE").toString());
            ...
            assertEquals(testMemberTaskListString,
                    project.getTasks().getAllSortedTaskDetails(project.getTasksAndAssignedMembers(),"/WHO-Jerry").toString());
            assertEquals(testMemberTaskListString2,
                    project.getTasks().getAllSortedTaskDetails(project.getTasksAndAssignedMembers(),"/WHO-Dillen").toString());
