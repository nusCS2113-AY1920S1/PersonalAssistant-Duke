...
class TaskListTest {
    ...
    void testGetAllTaskDetails() {
        ...
        String testTaskListString = "[1. task1 | Priority: 1 | Due: -- | Credit: 100 | State: OPEN, "
    ...
    void testGetAllSortedTaskDetails() {
        ...
        try {
            ...
            String testPriorityTaskListString = "["
                    + "1. taskOne | Priority: 1 | Due: 31 Oct 2019"
                    + dateTimeHelper.getDifferenceDays(dueDate1)
                    + " | Credit: 100 | State: OPEN, "
                    + "2. taskTwo | Priority: 2 | Due: 21 Sep 2019"
                    + dateTimeHelper.getDifferenceDays(dueDate2)
                    + " | Credit: 90 | State: DONE, "
                    + "3. taskEight | Priority: 3 | Due: 21 Jan 2020"
                    + dateTimeHelper.getDifferenceDays(dueDate3)
                    + " | Credit: 80 | State: OPEN, "
                    + "4. taskSix | Priority: 4 | Due: 21 Dec 1920"
                    + dateTimeHelper.getDifferenceDays(dueDate4)
            ...
            assertEquals(testCreditTaskListString,taskList.getAllSortedTaskDetails(
                    project.getTasksAndAssignedMembers(),"-credits", project).toString());
            ...
            assertEquals(testKanbanTaskListString,taskList.getAllSortedTaskDetails(
                    project.getTasksAndAssignedMembers(),"-state done", project).toString());
            ...
            assignmentController2.assignAndUnassign("assign task -i 2 -to 1".substring(12));
            ...
            /*assertEquals(testMemberTaskListString,
                    taskList.getAllSortedTaskDetails(
                            project.getTasksAndAssignedMembers(),"-who Jerry", project).toString());
            assertEquals(testMemberTaskListString2,
                    taskList.getAllSortedTaskDetails(
                            project.getTasksAndAssignedMembers(),"-who Dillen", project).toString());*/
