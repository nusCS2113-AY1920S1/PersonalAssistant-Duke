...
class TaskTest {
    ...
    void testGetTaskRequirements() {
        try {
            ...
            ITask task = consoleInputFactory.create("-n task1 -p 1 -d 19/10/2019 -c 10 -s todo -r requirement1");
            ...
            ITask task2 = consoleInputFactory.create("-n task2 -p 2 -c 10 -r requirement1 -r requirement2");
