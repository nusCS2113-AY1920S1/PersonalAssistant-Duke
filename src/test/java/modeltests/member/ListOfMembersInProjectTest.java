...
class ListOfMembersInProjectTest {
    ...
    void testAddMember() {
        ...
        assertEquals("1. Tom (Phone: 91198766 | Email: tom@gmail.com | Role: member)",
    ...
    void testEditMember() {
        ...
        assertEquals("1. John (Phone: 91177777 | Email: john@gmail.com | Role: member)",
                listOfMembersInProject.getMember(1).getDetails());
        listOfMembersInProject.editMember(1,"-n Matthew -e matthew@gmail.com");
        assertEquals("1. Matthew (Phone: 91177777 | Email: matthew@gmail.com | Role: member)",
                listOfMembersInProject.getMember(1).getDetails());
    }
