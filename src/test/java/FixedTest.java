...
class FixedTest {
    ...
    void testToString_createAndMarkDoneNewTask_newTaskCreatedAndMarkedDoneWithToStringFormat() {
    ...
    @org.junit.jupiter.api.Test
    void testStoreString_createAndMarkDoneNewTask_newTaskCreatedAndMarkedDoneWithStoreStringFormat() {
        Task task = new Fixed("read sales report", "2 hours");
