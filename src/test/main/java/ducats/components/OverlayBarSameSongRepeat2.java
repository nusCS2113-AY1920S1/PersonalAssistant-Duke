...
public class OverlayBarSameSongRepeat2 extends TestCase {
    @Test
    ...
    public void testGroupGroup() {
        ...
        String expected = "{UPPER_A UPPER_B }{UPPER_A UPPER_B }{UPPER_A UPPER_B }{UPPER_A UPPER_B }|" +
                ...
                "{UPPER_E UPPER_B }{UPPER_E UPPER_B }{UPPER_E UPPER_B }{UPPER_E UPPER_B }|" +
                "{UPPER_F UPPER_B }{UPPER_F UPPER_B }{UPPER_F UPPER_B }{UPPER_F UPPER_B }|" +
        ...
        AddOverlayCommand tester = new AddOverlayCommand("overlay 2 1 repeat");
        try {
