...
public class OverlayGroupGroupTestUnequalGroup extends TestCase {
    @Test

    //this test case tests when overlaying a larger group on a smaller group. (size 4 onto size 3)
    ...
    public void testGroupGroup() {
        ...
        ducats.commands.GroupCommand grouper = new ducats.commands.GroupCommand("group 1 4 Twinkle1");
        ...
        OverlayGroupGroup tester = new OverlayGroupGroup("overlay_group_group Twinkle 1 Twinkle 2 repeat");
        try {
