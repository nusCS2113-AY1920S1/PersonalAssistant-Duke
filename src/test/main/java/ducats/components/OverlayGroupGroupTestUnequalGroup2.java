...
public class OverlayGroupGroupTestUnequalGroup2 extends TestCase {
    @Test

    //this test case tests when overlaying a smaller group onto a larger group. (size 3 onto size 7)
    ...
    public void testGroupGroup() {
        ...
        ducats.commands.GroupCommand grouper = new ducats.commands.GroupCommand("group 1 7 Twinkle1");
