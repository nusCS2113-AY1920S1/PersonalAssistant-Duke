/**
 * Parser class that deals with making sense of user commands
 */
public class Parser {
	/**
	 * Returns a Command object which will be specific to the keywords given in the user command
	 ...
	 * @return Command the class Command will execute the user command
	 * @throws DukeException in case of user input errors which Parser cannot recognise, the parser will return
