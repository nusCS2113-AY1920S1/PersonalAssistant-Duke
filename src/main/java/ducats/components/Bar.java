...
import ducats.commands.CopyObject;
...
public class Bar extends CopyObject<Bar> implements Serializable {
     ...
     */
    public Bar(int id, String notes) throws DucatsException {
        this.id = id;
     ...
     */
    public Bar(int id, ArrayList<Chord> chords) throws DucatsException {
        this.id = id;
        this.chords = chords;
     ...
     */
    public Bar copy(Bar object) throws DucatsException, IOException,ClassNotFoundException {
     ...
     */
    static ArrayList<Note> convertStringToNotes(String notes) throws DucatsException {
     ...
     * @throws DucatsException an exception indicating the incorrect adding of a Bar due to invalid format
     */
    public static void checkLength(ArrayList<Chord> chords, int eighthNotesPerBar) throws DucatsException {
        if (chords.size() != eighthNotesPerBar) {
            throw new DucatsException("addbar", "");
        }
    }
}
