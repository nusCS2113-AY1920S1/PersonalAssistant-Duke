...
/**
 * Class Ui that deals with user interactions
 */
public class Ui {
	private Scanner scanner;

	/**
	 * Constructor of class Ui
	 * creates a new instance of Ui by initialising a new instance of a Scanner object
	...
	/**
	 * Reads the user input and returns it in a String form to be parsed by the Parser class
	...
	/**
	 * shows the user each Task object entry in the TaskList
	 * @param i the index of the Task object
