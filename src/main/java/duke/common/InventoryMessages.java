...
public class InventoryMessages {
    ...
    public static final String MESSAGE_INGREDIENTS_CLEARED = "All ingredients in the inventory has been cleared. "
            + "The inventory list is now empty.";
    ...
    public static final String ERROR_MESSAGE_INVALID_QUANTITY = "Quantity of ingredient should be a number. "
            + "Please input the command again.";
    public static final String ERROR_MESSAGE_INVALID_UNIT = "Unit of the ingredient is not supported yet. "
            + "Please input the command again with a supported unit.";
    ...
    public static final String ERROR_MESSAGE_INVENTORY_ALREADY_EMPTY = "Your inventory is already empty. "
