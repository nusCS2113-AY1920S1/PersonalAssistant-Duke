...
public class FixedPrompt extends Prompt {
    ...
    public void execute(String input, Ui ui) {
        switch(state) {
            case 0:
                ui.show(PromptMessages.FIXED_PROMPT_STARTER);
                state++;
                break;
            case 1:
                ui.show(PromptMessages.FIXED_PROMPT_HOUR);
                description = input;
                state++;
                break;
            case 2:
                ui.show(PromptMessages.FIXED_PROMPT_MIN);
                hour = input;
                break;
            case 3:
                ui.show(PromptMessages.FIXED_PROMPT_SUCCESS);
                min = input;
