...
public class Observation extends Evidence {
     ...
     * Attributes:
     * - name: information on the observation / symptom
     * - impression: the impression object the evidence is tagged to
     * - summary: a summary of what led to the observation
     * - isObjective: whether the observation has physical evidence or is a symptom reported by the patient
