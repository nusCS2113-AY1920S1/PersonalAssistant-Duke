...
public class HelpCommand extends Command {
    ...
    public void execute(TaskList tasks, Ui ui, Storage storage) throws IOException, ParseException, DukeException {
        ...
        System.out.println("Words in UPPER_CASE are the parameters to be supplied by the user e.g. in "
                + "todo DESCRIPTION, DESCRIPTION is a parameter which can be used as todo read book.");
        System.out.println("Items in square brackets are optional e.g DESCRIPTION [-FLAG] can be used as read book "
                + "-r or as read book.");
        System.out.println("Items with ... after them can be used multiple times including zero times e.g. [-FLAG]... "
                + "can be used as   (i.e. 0 times), -r, -f, etc.\n");
        ...
        System.out.println("You may use a recurring flag -r weekly or -r daily when creating a task: e.g. todo spanish "
                + "homework -r weekly");
