...
public class Message {
    ...
    public static final String MESSAGE_INVALID_PREFIX = "Prefix does not exists.";
    ...
    public static final String MESSAGE_INVALID_NUMBER_FORMAT = "Number format is invalid.";
