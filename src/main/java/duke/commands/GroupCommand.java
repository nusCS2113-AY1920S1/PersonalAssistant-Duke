...
public class GroupCommand extends Command<SongList> {
    ...
    public String execute(SongList songList, Ui ui, Storage storage) throws DukeException {
        ...
        try{
            ...
            start_no = Integer.parseInt(sections[0]);
            end_no = Integer.parseInt(sections[1]);
            name = sections[2];
            ...
            //code to add this group into the storage
            return ui.formatGroupBar(start_no, end_no, name);
        } catch (Exception e){
