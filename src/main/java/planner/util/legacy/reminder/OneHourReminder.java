...
public class OneHourReminder extends Reminder {

    private List<Task> tasks;

    public OneHourReminder(List<Task> tasks, TimeInterval remindBefore, TimeInterval checkEvery)
            throws ModTimeIntervalTooCloseException {
        super(remindBefore, checkEvery);
    }

    public OneHourReminder(List<Task> tasks, int minutesBefore, int minutesEvery)
            throws ModTimeIntervalTooCloseException {
        super(minutesBefore, minutesEvery);
    }

    public OneHourReminder(List<Task> tasks, TimeInterval remindBefore) throws ModTimeIntervalTooCloseException {
        super(remindBefore);
    }

    public OneHourReminder(List<Task> tasks, int minutesBefore) throws ModTimeIntervalTooCloseException {
        super(minutesBefore);
    }

    public OneHourReminder(List<Task> tasks) throws ModTimeIntervalTooCloseException {
        super();
    }
