...
public class HelpCommand extends Command {
	public static final String MESSAGE_SUCCESS = "Currently we support the following commands: (all command ignore cases)\n"
			...
			+ String.format("%1$-50s", "  'profit -t1 time1 -t2 time2 -all OR -i <number> OR -n <food name> OR -t <food type>'") + "generate the profit & revenue for a food product in the list, -all for all food\n"
