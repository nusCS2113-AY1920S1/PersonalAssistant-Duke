...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_SUCCESS = "This is the food you want to find:\n"
            + "%1$s\n";
    public static final String MESSAGE_SUCCESS_M = "There are in total %1$s food you want to find:\n"
            + "%2$s\n";
            ...
            case TYPE:
                ...
                for (int i = 0; i < list.size(); i++) {
                    if (list.get(i).getType() != null
                            && list.get(i).getType().toLowerCase().equals(
                                    findDescription.toLowerCase())) {
                        result.add(list.get(i));
                        count++;
                    }
                }
