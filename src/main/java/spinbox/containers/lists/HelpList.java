...
public class HelpList {
    ...
    public final String helpOnly = helpOutput.concat(horizontalLine + "Welcome to the help page. Below is the full "
            + "list of help commands.\n" + "You may view individual help commands by providing the specific command "
            + "after the 'help' keyword.\n" + "Example:\n" + "\tTo view the help page for the 'remove' command: "
            + "help / remove\n"
    ...
    public final String add = helpOutput.concat(horizontalLine + "Command: add\n"
    ...
    public final String remove = helpOutput.concat(horizontalLine + "Command: remove\n"
    ...
    public final String removeMultiple = helpOutput.concat(horizontalLine + "Command: remove-multiple\n"
    ...
    public final String updateMultiple = helpOutput.concat(horizontalLine + "Command: update-multiple\n"
            ...
            + "\t2. Mark the first 2 grade components under CG1111: TBC\n"
            + "\t3. Mark the first 2 tasks under module CG1111: mark-multiple CG1111 / task 1,2\n" + horizontalLine);
}
