...
public class Exam extends Schedulable {
     ...
     */
    public Exam(String description, DateTime startDate, DateTime endDate) throws ScheduleDateException {
        super(description);
     ...
     * @param endDate Date object for end DateTime.
     */
    public Exam(int done, String description, DateTime startDate, DateTime endDate) throws ScheduleDateException {
        super(description);
