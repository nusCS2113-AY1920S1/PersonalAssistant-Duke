...
/**
 * Class that deals with the saving and loading of all Task data the user has saved
 * Uses JSON file as the file type which the TaskList is saved
 * Loads the data stored in the JSON file into an ArrayList of Tasks that
 * can be used to construct a new instance of TaskList which has all the saved Task data
 */
public class Storage {
	 ...
	 * Converts the data into an ArrayList of Tasks with all saved Task data
	 * Returns this ArrayList for user to update progress or new tasks
	 * @return ArrayList of Task the ArrayList with all the saved Task data
	...
	/**
	 * Transfers all current Task data saved in the TaskList into an ArrayList of Tasks
	 * Writes all data in this ArrayList onto the JSON file specified in the filePath attribute
	 * @param tasks the TaskList with all the saved Task data
