...
public class SortHelper {
     ...
     */
    public ArrayList<String> sortTaskMember(HashMap<String, ArrayList<String>> tasksAndAssignedMembers,
                                            ArrayList<Task> taskList, String memberName, Project project) {
