...
public class OptixResponse {
    ...
    public final String ADD_MENU = "To add a new show:                            add SHOW_NAME|SCHEDULED_DATE|PRICE|SEATS_BASE_PRICE\n";

    public final String DELETE_MENU = "To delete shows with particular name:         delete-all SHOW_NAME_1|SHOW_NAME_2 | ...\n"
            + "To delete shows with specific name and date:  delete SHOW_NAME|SHOW_DATE\n";

    public final String VIEW_MENU = "To view availability of seats for a show:     view SHOW_NAME | SHOW_DATE\n";

    public final String SELL_MENU = "To sell seats to the audience:                sell SHOW_NAME | SHOW_DATE | BUYER_NAME\n";

    public final String LIST_MENU = "To list all shows for viewing:                list\n"
            + "To list all dates for a specific show:        list SHOW_NAME\n";

    public final String POSTPONE_MENU = "To postpone a show to a later date:           postpone SHOW_NAME | OLD_DATE | NEW_DATE\n";

    public final String MENU = "Here are the Commands to use Optix: \n"
            + ADD_MENU + DELETE_MENU + LIST_MENU + SELL_MENU + POSTPONE_MENU + VIEW_MENU;
}
