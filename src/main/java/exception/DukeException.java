...
public class DukeException extends Exception {
    ...
    public void showError() {
        ...
        case COMMAND_INVALID:
            System.out.println("     ☹ OOPS: I don't understand what you have entered.");
            break;
        case INDEX_MISSING:
        ...
        case FORMAT_RECURRING:
            ...
            break;
        case FORMAT_RECURRING_DATE:
            System.out.println("     ☹ OOPS: Recurring task cannot have a specific date");
            break;
        case FORMAT_VIEW:
            System.out.println("     ☹ OOPS: Expected format: \"view DD/MM/YYYY");
            break;
        case INVALID_DATE_TIME:
            System.out.println("     ☹ OOPS: Your input date and time is not correct");
            break;
        case FORMAT_FIXED:
