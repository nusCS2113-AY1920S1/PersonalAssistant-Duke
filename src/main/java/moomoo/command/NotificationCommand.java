...
public class NotificationCommand extends Command {
    ...
    public void execute(ScheduleList calendar, Budget budget, CategoryList catList, Category category,
        ...
        if (expenditure > budget.getBudgetFromCategory(cat)) {
            alert = "\u001B[36m" + "You have exceeded your budget of " + budget.getBudgetFromCategory(cat) + " for " + cat + "!\n";
            ...
            alert = "\u001B[36m" + "You are reaching your budget limit of " + budget.getBudgetFromCategory(cat) + " for " + cat
                    + ".\n";
        }
