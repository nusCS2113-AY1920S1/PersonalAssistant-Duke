/**
 * Superclass for all Tasks that will be added to the Task Manager
 */
public class Task {
	 ...
	 * Creates a new instance of Task by taking in a String description
	...
	/**
	 * Returns a String object to show if a Task has been marked done or not
