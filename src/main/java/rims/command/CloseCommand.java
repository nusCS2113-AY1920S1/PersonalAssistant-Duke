...
public class CloseCommand extends Command {
    /**
     * Saves all existing Resources and Reservations to disk in a text format, sends a farewell
     * message, and sets the exit code to true to halt the RIMS program.
