...
public class CreateAccountCommand extends Command {
    ...
    public CreateAccountCommand(String input, String[] splitStr) throws DukeException, IOException {
        ...
        if (splitStr.length == 1) {
            throw new DukeException("\u2639 OOPS!!! Please create your account with the following format: " +
        ...
        if (!splitC[1].contains("@u.nus.edu")) {
            throw new DukeException("\u2639 OOPS!!! Please create an account using your NUS email ending with " +
                    "@u.nus.edu");
        }
