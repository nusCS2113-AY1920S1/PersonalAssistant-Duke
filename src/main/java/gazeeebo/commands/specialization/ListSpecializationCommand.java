...
public class ListSpecializationCommand {
    ...
    public ListSpecializationCommand(Ui ui, Storage storage, Map<String, ArrayList<ModuleCategory>> specMap, Map<String, ArrayList<String>> completedEMap) throws IOException {
        ...
        else if (specChosen == INTELLIGENT_SYSTES_INDEX) {
            System.out.println("Breadth:");
