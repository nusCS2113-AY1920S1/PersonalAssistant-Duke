...
public class CompletedCommand {
    ...
    public CompletedCommand(Ui ui, Storage storage, Map<String, ArrayList<ModuleCategory>> specMap, Map<String, ArrayList<String>> completedEMap) throws IOException {
