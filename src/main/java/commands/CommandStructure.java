...
public class CommandStructure {
    ...
    public static TreeMap<COMMANDKEYS, String> cmdHelp = new TreeMap<>() {
        {
            put(COMMANDKEYS.search , "Search for movies,tvshows, cast etc.\neg.: search movies MOVIE_NAME [-P][-C][-L]");
            put(COMMANDKEYS.view , "Search for movies,tvshows, cast etc.\neg.: search movies MOVIE_NAME [-P][-C][-L]");
            put(COMMANDKEYS.add , "Search for movies,tvshows, cast etc.\neg.: search movies MOVIE_NAME [-P][-C][-L]");
            put(COMMANDKEYS.help , "Search for movies,tvshows, cast etc.\neg.: search movies MOVIE_NAME [-P][-C][-L]");
            put(COMMANDKEYS.more , "Search for movies,tvshows, cast etc.\neg.: search movies MOVIE_NAME [-P][-C][-L]");
            put(COMMANDKEYS.set , "Search for movies,tvshows, cast etc.\neg.: search movies MOVIE_NAME [-P][-C][-L]");
            put(COMMANDKEYS.preference , "Search for movies,tvshows, cast etc.\neg.: search movies MOVIE_NAME [-P][-C][-L]");
            put(COMMANDKEYS.playlist , "Search for movies,tvshows, cast etc.\neg.: search movies MOVIE_NAME [-P][-C][-L]");
        }
    };
