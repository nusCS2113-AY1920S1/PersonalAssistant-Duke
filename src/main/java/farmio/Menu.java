...
public class Menu {
     ...
     * @param resume True if game can be resumed.
     * @throws FarmioFatalException Fatal error from Simulator and must stop program.
     */
    public static void show(Ui ui, Simulation simulation, boolean hasSave, boolean resume) throws FarmioFatalException {
        if (resume && hasSave) { //resume, save and load
