            ...
            if (manageProjectInput.hasNextLine()) {
                ...
                if (projectCommand.length() == 4 && ("exit").equals(projectCommand.substring(0, 4))) {
                    ...
                    */
                    ...
                    System.out.println(projectCommand.substring(12));
                    String [] test = projectCommand.substring(12).split(" ");
                    for (String s :test) {
                        System.out.println(s);
                    }
                    AssignmentController.manageAssignment(projectToManage, projectCommand.substring(12).split(" "), consoleView);
                } else {
