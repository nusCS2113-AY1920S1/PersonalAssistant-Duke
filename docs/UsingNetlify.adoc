...
+
.Granting or requesting access
image::grant_or_request_access.png[Grant or request access, width = 800]
...
+.Viewing site name
image::temp_site_name.png[Temporary site name, width = 800]
+
...
+
.Previewing updated documentation
image::netlify_details.png[Netlify details link, width = 800]
...
+
.Changing site name
image::change_site_name.png[Change site name, width = 800]
