...
+
image:grant_or_request_access.png[Grant or request access, width = 630]
...
+
image:temp_site_name.png[Temporary site name, width = 630]
+
...
+
image:netlify_details.png[Netlify details link, width = 630]
...
+
image:change_site_name.png[Change site name, width = 630]
