...
. System requests for savings account and newly specified information of savings account details.
. User enters savings account with new savings account information he/she like to change.
. System update the savings account with new savings account details.
+
Use case ends.
