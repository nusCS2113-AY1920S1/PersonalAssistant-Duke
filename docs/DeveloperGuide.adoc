...
|System: Duke 2.0|Actor: A-Level Graduate|Use Case: Check core modules for Bachelor of Engineering (Electrical Engineering)
. User types keyword “electrical” with search command
. DukeJr. returns all the degrees with keyword “electrical” (if like that, if you type engin won’t it return everything…?) 
