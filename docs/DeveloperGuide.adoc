...
* *Step 1c:* +
The `processLine` method of `StorageParser` class splits each line into its respective fields through the use of `,` delimiters before parsing and assign them into the correct fields.
