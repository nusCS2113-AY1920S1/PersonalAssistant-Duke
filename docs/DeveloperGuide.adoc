...
Delete operation is have the same syntax for all five sections. The table below use order as an example.
`order`
...
There are many product related operations.
=======
=== Adding a Product
...
to check the ingredients.
>>>>>>> 8dd3d2c46aa254438397e59ffb53b50d4a275b12
