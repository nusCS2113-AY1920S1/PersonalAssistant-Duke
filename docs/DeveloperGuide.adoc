...
This document specified architecture and software design decisions for BakingHome, a one-stop application for managers of home bakeries to manage their business efficiently.

=== Scope

This guide describes the software architecture and software design decisions for the implementation of BakingHome.
The intended audience of this document is the developers, designers, and software testers of BakingHome.

=== Using the Guide

This guide follows the following format:

`marke-up` text represents a component or a command.
...
Delete operation is have the same syntax for all five sections.
