...
Do not disable them. If you have disabled them, go to btn:[File] > btn:[Settings] > btn:[Plugins] to re-enable them.

=== Setting up the project in your computer
. Fork this repo, and clone the fork to your computer
. Open IntelliJ (if you are not in the welcome screen, click btn:[File] > btn:[Close Project] to close the existing project dialog first)
. Set up the correct JDK version for Gradle
.. Click btn:[Configure] > btn:[Project Defaults] > btn:[Project Structure]
...
. Should work on any standard OS as long as it has Java 11 or above installed 
