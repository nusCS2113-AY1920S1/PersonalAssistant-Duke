...
. Transfer fund between `bank` account (sufficient fund for transfer)
...
. Transfer fund between `bank` account (insufficient fund for transfer)
...
. Search for existing `savings` account
...
. Search for non-existing `savings` account
...
. Search for existing `investment` account
...
. Search for existing transaction records based on description
...
. Search for existing transaction records based on category
...
=== Find recurring expenditure in `savings` account

. Search for existing recurring expenditure based on description
...
. Search for existing recurring expenditure based on category
