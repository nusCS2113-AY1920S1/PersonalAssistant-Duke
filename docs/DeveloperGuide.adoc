...
|Duke2.0|Prospective Applicant to NUS Faculty of Engineering|User types keyword “electrical” with search command|

1. DukeJr. returns all the degrees with keyword “electrical”
2. User types the index of the degree he wishes to view from the list of returned searches
3. DukeJr. displays the Curriculum Structure, Specialisations and Minor, and Recommended Schedule for the degree
4. User reads the data
|===

|===
|System|Actor|Use Case|Process
|Duke2.0|Prospective Applicant to NUS Faculty of Engineering|View the whole list of possible commands for D2|

1. User requires help with command syntax
2. User types in the command in the following manner: `help`
3. D2 returns all the possible commands that it will accept
4. User reads the information
|===

|===
|System|Actor|Use Case|Process
|Duke2.0|Prospective Applicant to NUS Faculty of Engineering|Check core modules for Bachelor of Engineering (Electrical Engineering)|

1. User identifies a degree that he/she wishes to research
2. User types in the command in the following manner: `details EE`
3. D2 displays the degree requirements, including the core modules
4. User reads the information
|===

|===
|System|Actor|Use Case|Process
|Duke2.0|Prospective Applicant to NUS Faculty of Engineering|Compare core modules for EE and CEG|

1. User identifies two degrees he wishes to compare
2. User types in the command in the following manner: `compare EE CEG`
3. D2 displays similar and different modules from the two degrees
4. User reads the information
|===

|===
|System|Actor|Use Case|Process
|Duke2.0|Prospective Applicant to NUS Faculty of Engineering|Add CEG into degree list and view degree list|
...
3. D2 adds Electrical Engineering to the user’s degree list
4. User types in the command in the following manner: `degreelist`
5. D2 returns the user’s degree list with Electrical Engineering added
|===

|===
|System|Actor|Use Case|Process
|Duke2.0|Prospective Applicant to NUS Faculty of Engineering| Swap CEG with EE in degree|
...
3. D2 returns the user’s degree list with CEG and EE having switched indexes
|===
