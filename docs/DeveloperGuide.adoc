...
* If the organization is not shown, click `Review and add`
+
This should bring you to a GitHub page that manages the access of third-party applications. Depending on whether you are the owner of the repository, you can either grant access or request access to Travis CI so that it can access your commits and build your code.
...
+
. If the build is successful, you should be able to check the coverage details of the tests.
