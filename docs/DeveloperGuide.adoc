...
*Extensions*
[none]
* 3a. System detects invalid details for the new bank account.
** 3a1. System requests for the correct details.
** 3a2. User re-enters the details for new bank account.
** Steps 3a1-3a2 are repeated until the details for new bank account is entered correctly.
** Use case resumes from step 4.
...
*Extensions*
[none]
* 3a. System detects invalid bank account details.
** 3a1. System requests for the correct bank account details.
** 3a2. User re-enters the bank account details.
** Steps 3a1-3a2 are repeated until the bank account details entered are correct.
** Use case resumes from step 4.
