...
The commands are organised into sections, each relating to a particular feature. You may follow the
...
. Managing members
.. Please use these commands to manage delete members. In an empty project,
...
**** Example: `add member -n John`
**** Example: `add member -n Jerry Zuang -i 9123456 -e jerryzhang@gmail.com -r Lead`
**** Example: `add member -n Dillen -i 87654321`
**** Example: `add member -n Cynthia Lee -r Tester`
**** Example: `add member -n Abhishek -e abhishek@yahoo.com`
**** Example: `add member -n Justin`
**** Example: `add member -n Tommy`
...
**** Example: `delete member 6 7`
... Give roles for members: `role INDEX -n ROLE_NAME`
**** Example: `role 2 -n Badguy`
*** To check that member details were updated successfully, you may use `view members` again
...
**** Example: `edit task 1 -p 4 -c 80`
**** Example: `edit task 2 -s doing`
**** Example: `edit task 1 -d 11/11/2019 -n Singles Day -c 1`
...
**** Example: `view task -name`
**** Example: `view task -priority`
**** Example: `view task -credit`
**** Example: `view task -date`
**** Example: `view task -who EXISTING_MEMBER_NAME`
...
**** Example: `edit task requirements 2 -rm 1 2 -r do something`
... Agenda of Tasks: `agenda`

. Managing Task Assignments
.. Please use these commands to assign tasks to members. The assignments may be checked using the `view assignments` command.
...
**** Example: `assign task -i 1 -to 2 3 `
**** Example: `assign task -i 1 -rm 2`
**** Example: `assign task -i 2 -to all`
**** Example: `assign task -i 1 -to
