...
. DIYeats detects that user profile has not been specified and prompts for information regarding height, weight, and lifestyle

. Student enters the required information based on his profile

. DIYeats indicates that user profile has been recorded.
...
. Student chooses the food he/she is planning to eat and corresponds the food to the respective meal.
. DIYeats indicates the meal has been recorded.
. Steps 1-2 are repeated until Student has inputted all the meals intended
...
. NUS Student requests to display meal and the nutritional intake for today.
. DIYeats display the recorded meals taken / will be taken today and its nutritional value.
...
. User requests to be reminded on how much nutrition the student intake to reach the target nutrient intake for the month.
. DIYeats display the information.
...
. Student requests to find a specific food student had in the past
. DIYeats displays the queried food and its description.
...
. Student requests for nutritional goals to be met at the end of a time frame (end of month)
. DIYeats displays the nutritional goals that have been inputted and a confirmation goals.
. Use case ends.
...
. Student unsure of what food to eat for the next meal and asks DIYeats to recommend a food that fits within the goal intake set.
. DIYeats displays a small list of nutritional food that fit within the goal intake plan set by the student.
. Student can choose to select food from the list generated in step 2 or proceed to key in any other food as per normal.
...
. Student requests for the statistics of the amount of nutrients that have been eaten in a specific time frame.
. DIYeats displays the statistics, accompanied by the goal intake that is set by the student.
...
. Student requests for the graph of the amount of nutrients that have been eaten in a specific time frame.
. DIYeats displays the graph, accompanied by the goal intake that is set by the student.
Use case ends.
====
