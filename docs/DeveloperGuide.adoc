...
* The name of the savings account that acts as a keyword for the search.
...
. System requests the type of expenditure to be listed and the account to list from.
. User specifies the type of expenditure to be listed and the account to list from..
...
*Extensions*
[none]
* 3a. System detects invalid type of expenditure to be listed or account to list from.
** 3a1. System requests for the correct type of expenditure to be listed and the account to list from.
** 3a2. User re-enters the type of expenditure to be listed and the account to list from.
** Steps 3a1-3a2 are repeated until the type of expenditure to be listed and the account to list from are entered
correctly.
** Use case resumes from step 4.
...
* *User has a profile created*
* *User has existing savings account*
* *User has existing investment account*
* *User has existing card*
