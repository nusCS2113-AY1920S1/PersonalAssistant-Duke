...
image::UiActivityDiagram.png[width="300" align="left"]
...
image::LogicActivityDiagram.png[width="250" align="left"]

.CreateCommand Activity diagram
image::CreateCommandActivityDiagram.png[width="250" align="left"]

[[Design-Model]]
=== Model component

.Structure of the Model Component
image::ModelClassDiagram.png[width="300" align="left"]
...
image::StorageClassDiagram.png[width="300" align="left"]
...
image::StorageActivityDiagram.png[width="300" align="left"]
...
image::ConversationDiagram.png[width="300" height="300"]
...
image::EditActivityDiagram.png[width="300" height="200"]
...
image::EditSequenceDiagram.png[width="400" height="300"]
...
image::EditState0.png[height="100"]
...
.Diagram for edit state
image::EditState1.png[height="100"]
...
.Diagram for edit state
image::EditState2.png[width="200" align="left"]
