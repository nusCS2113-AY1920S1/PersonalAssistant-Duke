...
The actions involving University-Related Tasks are performed mostly using the `UniversityTaskHandler` class. This class handles all methods that are related to passively adding University-Related Tasks such as:

. `[CEG] NUS-ECE Open House`

. `[BME] Open House for Prospective Students`
