...
2. Referring to Figure , a parseInput() function is called, prompting the user for input. He/She enters the “return” keyword which is gathered by the Ui object.
