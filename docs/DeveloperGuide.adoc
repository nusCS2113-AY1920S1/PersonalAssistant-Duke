...
cancelled.
.. Entering the command `concert MyConcert/2-12-2019 1500 1600/30` followed by the command
`concert MyConcert/27-12-2019 1200 1400/21` will result in the system cancelling the second
operation due to exceeding of budget for the month of december 2019.
