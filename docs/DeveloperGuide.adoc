...
[discrete]
=== Use case: Create project (UC01) `create`
...
[discrete]
=== Use case: View all projects (UC02) `view`
...
[discrete]
=== Use case: Manage a project (UC03) `manage`
...
[discrete]
=== Use case: Add members to a specific project (UC04) `add member`
...
[discrete]
=== Use case: Edit members in a specific project (UC05) `edit member`
...
[discrete]
=== Use case: Add task in a specific project (UC06) `add task`
...
[discrete]
=== Use case: Edit task in a specific project (UC07) `edit task`
...
[discrete]
=== Use case: Assign tasks to members (UC08) `assign`
...
[discrete]
=== Use case: Complete tasks in a specific project (UC09) `done`
