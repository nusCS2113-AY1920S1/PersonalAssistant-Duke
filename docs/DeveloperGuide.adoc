...
[none]
* 2a. User types invalid input
+
[none]
** 2a1. Cake shows error message
Use case resumes at step 2.

[none]
* 2b. User types wrong answer
+
Cake shows "Wrong Answer" and proceeds to next question.
...
[none]
* 4a. User types in answer via the quiz options listed e.g. `1. A`, `2. A` etc.
+
Use case ends
