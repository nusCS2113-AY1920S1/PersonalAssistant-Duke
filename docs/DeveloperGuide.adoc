...
* `view history h/DATE to DATE` - lists the input commands entered by the user during a certain period.
* (proposed) `delete history h/DATE to DATE` - deletes the input commands entered by the user during a certain period.
