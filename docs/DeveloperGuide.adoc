...
image::Architecture main.png[width = 95%]
...
. During runtime: Acts as an intermediary between the `Parser` class and the `Command` class.
...
from the user whilst the `UI` class handles all necessary dissemination of information to the user through the terminal.
