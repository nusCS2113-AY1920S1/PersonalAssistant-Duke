...
. Add Deadline
.. Key in `Deadline dlevent /by 10-10-2010 2200` +
  Expected: Output should be +
  Got it. I've added this task: +
  [D][x] dltask (by: 10-10-2010 2200) +
  Now you have <previous number of items + 1> tasks in the list.
  
. Add Event
.. Key in `Event evttask /at 09-09-2009 0900` +
  Expected: Output should be +
  Got it. I've added this task: +
  [E][x] evttask (by: 09/09/2009 0900) +
  Now you have <previous number of items + 1> tasks in the list.
...
.. Key in `exam Music Rudiments /08-08-2018 0800 0900` +
   Expected: Output should be +
   Got it. I've added this task: +
   [ex][x] Music Rudiments (on 08-08-2018, 0800 - 0900) 
   Now you have <previous number of items + 1> tasks in the list.
