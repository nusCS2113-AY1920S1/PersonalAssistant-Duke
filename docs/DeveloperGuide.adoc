...
confusion and conflict to the end user, especially when the names clash with the name of another bond which has
expired prior to making this edit. This might confuse users as they might think that they earned much more interest
from the same bond.
a|
...
|27|* *|organised user|export to view my expenditures statement|review my monthly, quarterly and yearly expenses with
ease
...
*Actor: User* +
[[UC-2]] *Use case: UC2 - Add [.underline]#bank# (savings / investment) account* +
*Preconditions:*
...
. User chooses to add a [.underline]#bank# (savings / investment) account.
. System requests for [.underline]#bank# (savings / investment) details.
. User enters details for the new [.underline]#bank# (savings / investment) account.
. System creates a new [.underline]#bank# (savings / investment) account with the details specified.
+
Use case ends.

*Extensions*
[none]
* 3a. System detects invalid details for the new [.underline]#bank# (savings / investment) account.
** 3a1. System requests for the correct details.
** 3a2. User re-enters the details for new [.underline]#bank# (savings / investment) account.
** Steps 3a1-3a2 are repeated until the details for new [.underline]#bank# (savings / investment) account is entered correctly.
** Use case resumes from step 4.
...
*Actor: Existing User* +
[[UC-5]] *Use case: UC5 - Edit [.underline]#bank# (savings / investment) account details* +
*Preconditions:*

*  *User has a profile created* +
*  *User has an existing [.underline]#bank# (savings / investment) account* +

*Main success scenario:*

. User chooses to edit his/her [.underline]#bank# (savings / investment) account details.
. System requests for new [.underline]#bank# (savings / investment) account details.
. User enters new [.underline]#bank# (savings / investment) account details.
. System update the [.underline]#bank# (savings / investment) account details.
+
Use case ends.

*Extensions*
[none]
* 3a. System detects invalid [.underline]#bank# (savings / investment) accounts details.
** 3a1. System requests for the correct [.underline]#bank# (savings / investment) account details.
** 3a2. User re-enters the [.underline]#bank# (savings / investment) account details.
** Steps 3a1-3a2 are repeated until the [.underline]#bank# (savings / investment) account details entered are correct.
** Use case resumes from step 4.
