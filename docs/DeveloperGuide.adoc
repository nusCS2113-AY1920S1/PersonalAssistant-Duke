...
Given below is an example of how a calendar table is generated and printed.
...
This implementation also improves scalability as the Predicate class and the EventList.filteredList method can be reused for other
functionalities. 
