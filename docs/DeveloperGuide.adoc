...
=== Quiz feature
Generate quizzes to test the user’s understanding of a word, with a score at the end of the quiz. Statistic will be saved for the user to view his/her progress.
...
The quiz will output a word, and the 4 choices of meanings. Prompting the user to enter between “1 to 4” similar to MCQ picking before informing the user if they have gotten the quiz question correct. For example:

Usage case:

If the correct answer “1” is input into the program
