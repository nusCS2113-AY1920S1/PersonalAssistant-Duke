...
To use Duke, you should have basic knowledge of downloading and running applications. You should able to input simple text commands into a command line. You will not need any other technical knowledge to use D2 to its fullest potential.
