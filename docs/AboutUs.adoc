...
Features Implemented: CRUD of projects, Member Features (roles), Task features (agenda), Persistent data saving
...
Features Implemented: CRUD of reminders, Data Logging, Handling date objects, Task features (Creation of task)
