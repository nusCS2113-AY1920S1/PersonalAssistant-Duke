...
=== Lucas Foo
image::Lucas.png[width="150", align="left"]
...
===Liu Chao Jie
image::chaojie.png[width="150", align="left"]
{empty}[http://github.com/ChaojieLiu666[github]] [<<johndoe#, portfolio>>]

Role: Developer +
Responsibilities: Docmentation + Testing
