...
{empty}[https://github.com/gowgos5[github]] [<<portfolio/vernon#, portfolio>>]
...
{empty}[http://github.com/aquohn[github]] [<<portfolio/john#, portfolio>>]
...
{empty}[http://github.com/JacobToresson[github]] [<<portfolio/jacob#, portfolio>>]
...
{empty}[http://github.com/JeremyKwok[github]] [<<portfolio/jeremy#, portfolio>>]
