...
manager and email manager that works together. Duke Email Manager uses Graphical User Interface (GUI) for
students to use its functionalities by typing in commands.

This is what our project looks like:


My role was to write codes for the natural date format feature and
