= Tan Wee Theng Terence - Project Portfolio
...
their credit cards.
* *Justification*: Due to the popularity of credit cards, many people including students has one.
...
* *Highlights*: In line with real credit cards, users will be able to set their monthly spending limit
and rebates.
...
In addition, most credit cards also has benefits such as reward points or rebates.
This feature will allow users to track and manage their credit card expenditures on each of their cards.
* *Highlights*: In line with a real credit cards, users will have to abide by their monthly card limit
when adding expenditures. When a particular card has reached its monthly limit, user will no longer be able to
...
* Helped review and schedule various Pull Requests (PRs) to minimize merge conflicts and regressions.

==== 3.3.2 Additional Codes

* Design and wrote the initial Parser class (ParseCommand, ParseType, ParseRawData) with the contributions from
everyone (
...
* Helped team members debug issues related to parser and also performed regression testing of their codes.

==== 3.3.4 Documentation
* Came up with the initial set of User Stories and Use Cases for the Developer Guide.
* Corrected the User Guide and Developer Guide for grammatical errors.
...
I wrote the sections of the user guide related to the `card` function. The following contains an excerpt from our
OwlMoney link:https://github.com/AY1920S1-CS2113T-W17-3/main/blob/master/docs/UserGuide.adoc[User Guide],
showing additions that I have made for the `card` function.

=== 4.1 Credit card bill management commands: `/cardbill`

==== 4.1.1 Adding credit card bill to savings account `/add /cardbill`

include::../UserGuide.adoc[tag=AddCreditCardBill_Command]

==== 4.1.2 Deleting credit card bill from savings account `/delete /cardbill`
