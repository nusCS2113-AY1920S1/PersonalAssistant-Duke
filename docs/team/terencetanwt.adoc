...
* Organised and coordinate team meetings
...
* Reviewed, reported bugs, and provided constructive feedback to other team's
...
==== Adding Credit Card Bill to Savings Account `/add /cardbill`
