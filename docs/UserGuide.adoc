...
`/add /recurexpenditure /amount AMOUNT /from BANK_NAME /frequency MONTH/WEEK/YEAR /description DESCRIPTION
/category
[CATEGORY]`
...
`/delete /expenditure /from JunBank Savings Account /expno EXPENDITURE_NUMBER`
...
`/delete /recurexpenditure /from JunBank Savings Account /expno EXPENDITURE_NUMBER`
...
`/find /savings /name JunBank Savings Account /description bubble tea /from 1/1/2019 /to /to 7/1/2019`
