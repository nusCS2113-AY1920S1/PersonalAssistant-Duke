...
Starts task tracking from current time and displays total time spent on Task.
...
Pauses task tracking at current time and displays total time spent on Task thus far.
...
Stops task tracking at current time, marking Task as complete and displays total time spent on Task thus far.
