...
You can removed unwanted data if you have accidentally added an unwanted semester.
...
You can removed unwanted data if you have accidentally added a wrong module.
...
You can removed unwanted data if you have addded the wrong date for a lesson.
