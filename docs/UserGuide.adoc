...
Finds and lists all recurring expenditures that matches the description `spotif` within `JunBank Savings Account`.
...
Finds and lists all recurring expenditures that matches the category `bills` within `JunBank Savings Account`
