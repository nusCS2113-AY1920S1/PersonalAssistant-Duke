...
*OwlMoney* also comes with a minimalistic design that presents information in an organized
manner.
...
A savings account is compulsory as most features in *OwlMoney* require it.
...
.Successful adding of savings account after using `/add /savings`.
image::AddSavings.png[Caption="Figure : "]
...
.Successful editing of savings account after using `/edit /savings`.
image::EditSavings1.png[Caption="Figure : "]
...
.Successful editing of savings account after using `/edit /savings`.
image::EditSavings2.png[Caption="Figure : "]
...
.Successful deletion of a savings account after using `/delete /savings`.
image::DeleteSavings.png[Caption="Figure : "]

Deletes a savings account named `JunBank Savings Account`.

// tag::AddBankExpenditure[]
...
.Successful adding of bank expenditure after using `/add /bankexpenditure`.
image::AddBankExpenditure.png[Caption="Figure : "]
...
.Successful editing of bank expenditure after using `/edit /bankexpenditure`.
image::EditBankExpenditure1.png[Caption="Figure : "]
...
.Successful editing of bank expenditure after using `/edit /bankexpenditure`.
image::EditBankExpenditure2.png[Caption="Figure : "]
...
.Successful editing of bank expenditure after using `/edit /bankexpenditure`.
image::EditBankExpenditure3.png[Caption="Figure : "]
...
.Successful deleting of bank expenditure after using `/delete /bankexpenditure`.
image::DeleteBankExpenditure.png[Caption="Figure : "]
...
.Successful adding of deposit after using `/add /deposit`.
image::AddDeposit.png[Caption="Figure : "]
...
.Successful editing of deposit after using `/edit /deposit`.
image::EditDeposit1.png[Caption="Figure : "]

* `/edit /deposit /from JunBank Savings Account /transno 11 /amount 500`

.Successful editing of deposit after using `/edit /deposit`.
image::EditDeposit2.png[Caption="Figure : "]
...
.Successful deleting of deposit after using `/delete /deposit`.
image::DeleteDeposit.png[Caption="Figure : "]
...
.Successful addition of card after using `/add /card`
image::AddCard.png[Caption="Figure : "]
...
.Successful edition of card name after using `/edit /card`
image::EditCard3.png[Caption="Figure : "]
...
.Successful edition of card limit after using `/edit /card`
image::EditCard1.png[Caption="Figure : "]

Edits the credit limit of `POBB Tomorrow Card` to $`10000`.

* `/edit /card /name POBB Tomorrow Card /rebate 2.25`

.Successful edition of card rebate after using `/edit /card`
image::EditCard2.png[Caption="Figure : "]
...
.Successful deletion of card after using `/delete /card`
image::DeleteCard.png[Caption="Figure : "]
...
Only unpaid expenditures can be edited.
====
...
Only unpaid expenditures can be deleted.
====
...
.Successful deletion of card bill after using `/delete /cardbill`.
image::DeleteCardBill.png[Caption="Figure : "]

// end::DeleteCreditCardBill_Command[]
// tag::goals[]

==== Financial Goal Management
In this section, you'll be introduced to commands and parameters that can get you started to
...
.Successful addition of goals using `/in` as date parameter
ifdef::env-github[]
image::GoalsAddIn.png[width="800"]
endif::[]

ifndef::env-github[]
image::GoalsAddIn.png[width="970"]
endif::[]
...
.Successful addition of goals after using `/by` as date parameter
ifdef::env-github[]
image::GoalsAddBy.png[width="800"]
endif::[]

ifndef::env-github[]
image::GoalsAddBy.png[width="970"]
endif::[]
...
.Successful addition of goals tied to existing savings account after adding `/from` parameter
ifdef::env-github[]
image::GoalsAddSaving.png[width="800"]
endif::[]

ifndef::env-github[]
image::GoalsAddSaving.png[width="970"]
endif::[]
...
.Successful edition of goal name after using `/edit /goals /name` and `/newname`
ifdef::env-github[]
image::GoalsEditName.png[width="800"]
endif::[]

ifndef::env-github[]
image::GoalsEditName.png[width="970"]
endif::[]
...
.Successful edition of goal date and amount after using `/edit /goals /name` with `/by` and `/amount`

ifdef::env-github[]
image::GoalsEditDate.png[width="800"]
endif::[]

ifndef::env-github[]
image::GoalsEditDate.png[width="970"]
endif::[]
...
.Successful use of edit feature to link / unlink goals to / from savings account and mark done an un-tracked goals.
ifdef::env-github[]
image::GoalsEditMultiple.png[width="800"]
endif::[]

ifndef::env-github[]
image::GoalsEditMultiple.png[width="970"]
endif::[]
...
.Successful deletion of goal after using `/delete /goals /name`
ifdef::env-github[]
image::GoalsDelete.png[width="800"]
endif::[]

ifndef::env-github[]
image::GoalsDelete.png[width="970"]
endif::[]
...
.Successful edition of goal amount after using `/edit /profile /name` and `/newname`
ifdef::env-github[]
image::ProfileEdit.png[width="800"]
endif::[]
...
.Successful search of investment account after using `/find /investment`
...
.Successful search of bonds after using `/find /bonds`
...
Finds and lists all transactions that match the description `bubble tea` charged to `JunBank Savings Account`.

* `/find /banktransaction /name JunBank Savings Account /category food`

.Successful search of bank transaction by category after using `/find /banktransaction`
image::FindBankTransaction2.png[Caption="Figure : "]

Finds and lists all transactions that match the category `food` from the bank named `JunBank Savings Account`

* `/find /banktransaction /name JunBank Savings Account /from 1/1/2019 /to 7/1/2019`

.Successful search of bank transaction by date range after using `/find /banktransaction`
image::FindBankTransaction3.png[Caption="Figure : "]
...
.Successful search of bank transaction by description, category and date range after using `/find /banktransaction`
image::FindBankTransaction4.png[Caption="Figure : "]

Finds and lists all transactions that match any one of the categories:
...
.Successful search of card transaction by description after using `/find /cardtransaction`
image::FindCardTransaction1.png[Caption="Figure : "]

Finds and list all transactions that match with the description `bubble tea` from the credit card named `POBB
Tomorrow Card`

* `/find /cardtransaction /name POBB Tomorrow Card /category food`

.Successful search of card transaction by category after using `/find /cardtransaction`
image::FindCardTransaction2.png[Caption="Figure : "]

Finds and lists all transactions that match the category `food` from the credit card named `POBB Tomorrow Card`

* `/find /cardtransaction /name POBB Tomorrow Card /from 1/1/2019 /to 7/1/2019`

.Successful search of card transaction by date range after using `/find /cardtransaction`
image::FindCardTransaction3.png[Caption="Figure : "]
...
.Successful search of card transaction by description, category and date range after using `/find /cardtransaction`
image::FindCardTransaction4.png[Caption="Figure : "]
...
.Successful search of recurring expenditure by description after using `/find /recurbankexp`
image::FindRecur1.png[Caption="Figure : "]

Finds and lists all recurring expenditures that match the description `spotif` within `JunBank Savings Account`.

* `/find /recurbankexp /name JunBank Savings Account /category bills`

.Successful search of recurring expenditure by category after using `/find /recurbankexp`
image::FindRecur2.png[Caption="Figure : "]

Finds and lists all recurring expenditures that match the category `bills` within `JunBank Savings Account`

* `/find /recurbankexp /name JunBank Savings Account /desc spotif /category bills`

.Successful search of recurring expenditure by description and category after using `/find /recurbankexp`
image::FindRecur3.png[Caption="Figure : "]

Finds and lists all recurring expenditures that match any one of the categories:
...
.Successful listing of card expenditures after using `/list /cardexpenditure`.
image::ListCardExpenditure.png[Caption="Figure : "]
...
[TIP]
====
*OwlMoney* provides you with the flexibility to transfer funds between different account types. (e.g. Savings to
...
.Successful transfer between two savings account after using `/transfer /fund`
image::Transferfund1.png[Caption="Figure : "]

Transfers $`500` from `JunBank Savings Account` (savings account) to `POBB Savings Account` (savings account) on
`1/1/2019`.

* `/transfer /fund /from DBB Vickers Account /to JunBank Savings Account /amount 250 /date 1/1/2019`

.Successful transfer between savings and investment account after using `/transfer /fund`
image::Transferfund2.png[Caption="Figure : "]

Transfers $`250` from `DBB Vickers Account` (investment account) to `JunBank Savings Account` (savings account) on
`1/1/2019`
.
...
.Successful adding of recurring expenditure after using `/add /recurbankexp`.
image::AddRecurringExpenditure.png[Caption="Figure : "]
...
.Successful editing of recurring expenditure after using `/edit /recurbankexp`.
image::EditRecurringExpenditure.png[Caption="Figure : "]
...
.Successful deleting of recurring expenditure after using `/delete /recurbankexp`.
image::DeleteRecurringExpenditure.png[Caption="Figure : "]
...
This updates any incoming income or interest that you are potentially scheduled to earn or any
recurring expenditures that are supposed to be charged.
...
| *Finding transaction records within a specified bank account or card that match with the keyword specified by the
user*
...
=======
| *Finding recurring expenditure records within a specified savings account that matches with the keyword
...
| Checks all recurring transactions and updates the profile if needed.

This includes income, recurring expenditures, interests from bonds.
