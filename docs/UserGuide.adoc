...
// tag::schedule[]
=== Setting a study reminder : `schedule`

Sets a reminder given a user specified date and time, tagged to a list of words to be revised. +
Format: `schedule`

****
* Users can set a reminder for multiple words at one go.
****

Examples:

* Enter `schedule` +
Enter a list of 'enter key' separated words: `life\n is\n great\n` +
...
Format: `history {number of past entries to be shown}`
