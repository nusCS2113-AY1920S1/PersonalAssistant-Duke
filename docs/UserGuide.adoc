...
=== 3.1 Adding a task : `todo/deadline/event/doafter`
Adds a todo/deadline/event/doafter to the tasklist.
...
Format: `todo DESCRIPTION`  
  ...
  - `TASK` is a task that has been previously added, seeing that a DoAfter task can only be done after an existing task has been done.
...
* *Add*: `todo DESCRIPTION` `deadline DESCRIPTION /by dd/mmm/yyyy hhmm` `event DESCRIPTION /at dd/mm/yyyy hhmm` `doafter DESCRIPTION /after TASK` +
