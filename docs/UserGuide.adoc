...
typing your *USER NAME* when prompted and pressing kbd:[Enter]
...
| `BOND_RATE`
| Indicates the coupon rate of the investment bond.
...
| `CASHBACK_RATE`
| Indicates the cash back returns rate of the credit card.
