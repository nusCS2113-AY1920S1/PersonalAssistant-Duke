...
=== Listing all degrees in your degree list: `choices` [[choices]]
...
Format: `view_employment <DEGREE>` (The degree entered MUST be the keyword of that particular degree)
...
Format: `cohort_size <DEGREE>` (The degree entered MUST be the keyword of that particular degree)
