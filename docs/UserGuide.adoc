...
.Successful addition of goals using `/add /goals /in`
ifdef::env-github[]
...
.Successful addition of goals after using `/add /goals /by`
ifdef::env-github[]
...
.Successful addition of goals tied to existing savings account after using `/add /goals /from`
ifdef::env-github[]
...
.Successful edition of goal name after using `/edit /goals /newname`
ifdef::env-github[]
...
.Successful edition of goal date and amount after using `/edit /goals /by /amount `
ifdef::env-github[]
...
.Successful edition of goal amount after using `/edit /profile /name`
ifdef::env-github[]
