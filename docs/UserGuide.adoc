...
* *Start Task Tracker*: `start ASSIGNMENT_DESCRIPTION`
e.g. `start user guide`

* *Pause Task Tracker*: `pause ASSIGNMENT_DESCRIPTION`
e.g. `pause user guide`

* *Stop Task Tracker*: `stop ASSIGNMENT_DESCRIPTION`
e.g. `stop user guide`
