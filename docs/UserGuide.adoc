...
Adds a goal named GRAD TRIP which aims to save $`2000` by `30/12/2019` and tie it to a savings account named `JunBank
Savings Account`.
...
[TIP]
====
You can also add a savings account if the existing goal has no account linked to it.
====
...
* BANK_NAME -> JunBank Savings Account | DESCRIPTION -> bubble tea

* BANK_NAME -> JunBank Savings Account | FROM -> 1/1/2019  TO -> 7/1/2019

* BANK_NAME -> JunBank Savings Account | CATEGORY -> food
