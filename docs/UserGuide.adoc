...
Format: `*modify* [LIST NO.] {COMPONENT}`
...
Format: `*create shortcut* [LIST NO.]`
...
Format: `*create shortcut expense/income* [DESCRIPTION] [AMOUNT] {TAG}`
...
Format: `*add shortcut* [SHORTCUT NO.]`
...
Format: '*shortcut modify* [SHORTCUT NO.] {COMPONENT}'
...
Format: `*shortcut remove* [SHORTCUT NO.]`
