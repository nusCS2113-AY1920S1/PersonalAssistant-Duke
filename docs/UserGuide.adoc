...
Format: `start MODULE_CODE`

Example: `start CS2113T`
...
Format: `pause MODULE_CODE`

Example: `pause CS2113T`
...
image::demo_images/Demo_ViewTrackerTimePeriod.png[]
