...
.. `/add /bankexpenditure /savings /amount 13.50 /from JunBank Savings Account [/category entertainment]` (with optional
`category`
parameter)
...
* `/add /bonds /from DBB Vickers Account /name June SSB /amount 1000 /rate 1.92 /year 1`
...
Changes the bond named `June SSB` charged to `DBB Vickers Account` with a new interest rate of `1.98`%.
...
In this section, you'll be introduced to commands and parameters that helps you to find and sieve information
that you require quickly out of *OwlMoney*.

===== Finding savings account details `/find /savings`

Can't remember the name of your savings account? Don't worry *OwlMoney* allows you to find out details of
your bank account as long as your remember part of your account name.
...
Finds and lists all savings accounts that has the phrase `Jun` in the account name.

===== Finding investment account details `/find /investment`

Can't remember the name of your investment account? Don't worry *OwlMoney* allows you to find out details of
your bank account as long as your remember part of your account name.
...
Finds and lists all investment accounts that has the phrase `vickers` in the account name.

===== Finding credit card details `/find /card`

Searching for a Credit Card? *OwlMoney* helps you by providing you various ways to do it!
...
Finds and lists all card with the name that contains the phrase `POBB`.

===== Finding bond details `/find /bonds`

Searching for an investment bond within an investment account? *OwlMoney* is able to help you with that by providing
...
Finds and lists all bonds with bond name that contains SSB from the investment account called DBB Vickers Account.
...
`/find /banktransaction /name JunBank Savings Account /desc bubble tea /from 1/1/2019 /to 7/1/2019`

Finds all transactions with the description `bubble tea` charged to `JunBank Savings Account` between `1/1/2019` and
`7/1/2019`.
...
`/find /cardtransaction /name CARD_NAME /desc DESCRIPTION_KEYWORD [/from FROM_DATE /to TO_DATE]`

*Example*

`/find /cardtransaction /name POBB Tomorrow Card /desc bubble tea /from 1/1/2019 /to 7/1/2019`

Finds all transactions with the description `bubble tea` charged to `POBB Tomorrow Card` between `1/1/2019` and
 `7/1/2019`.
...
`/transfer /fund /from ACCOUNT_NAME /to ACCOUNT_NAME /amount AMOUNT`

[TIP]
====
*OwlMoney* allows you to transfer funds between investment and savings accounts.
====

*Example*

* `/transfer /fund /from JunBank Savings Account /to POBB Savings Account /amount 500`

Transfers $`500` from `JunBank Savings Account` to `POBB Savings Account`.

* `transfer /fund /from DBB Vickers Account /to JunBank Savings Account /amount 250`
...
Adds a recurring expenditure that deducts $`72.90` every month to pay `Telco Bills` charged to `JunBank Savings
...
[WARNING]
====
At least one of `/desc`, `/category`, `/amount` must be used.
====
...
Changes recurring expenditure number `2` description to `Telco Bills` to charge $`119.90`.
