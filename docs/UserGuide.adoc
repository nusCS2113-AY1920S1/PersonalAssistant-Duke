...
Format: `recommend HOTELLOCATION between STARTDATE and ENDDATE`
...
* `newItinerary 23/04/15 25/04/15 MBS TwoDayHoliday 1 /venue Simei /do dancing /and singing /and swinging 2 /venue Bedok /do running /and jumping /and swinging`

A itinerary with multiple venues in 1 day.

* `newItinerary 23/04/15 24/04/15 Bedok SundayVacay 1 /venue Bedok /do swimming /and jumping /and swinging /venue Semei /do jogging /and running`
