...
=== Adding a degree into your list: `add`
...
// tag::delete[]
=== Deleting a degree in the list : `delete`

Deletes the specified degree from the list. +
Format: `delete INDEX`
...
* `delete 2` +
Deletes the 2nd degree in the list.

// end::delete[]
=== Clearing all entries in the list: `clear`
