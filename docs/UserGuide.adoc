...
===== Adding recurring expenditures for bills `/add /recurexpenditure`
...
===== Adding deposit to bank account `/add /deposit`
...
===== Editing deposit details `/edit /deposit`
...
===== Deleting deposit `/delete /deposit`
