...
Complete with your Task? Stop task tracking at current time with `stop`.
...
image::demo_images/Demo_ViewTracker.png[]

Example: `viewTracker DAY`

image::demo_images/Demo_ViewTracker.png[]

Example: `viewTracker WEEK`
