...
Adds a new RouteNode to SGTravel. +
...
* RouteNodes are specific bus stops or mrt stations in a Route.
...
Shows the Route on the Singapore map. +
...
Deletes a RouteNode at the specified indexes. +
