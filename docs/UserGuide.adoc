...
* `/edit /investment /name POBB Vickers Account /newname OBOB Securities Account`

Changes the name of the account from `POBB Vickers Account` to `OBOB Securities Account`.

* `/edit /investment /name POBB Vickers Account /amount 50000`

Changes the amount in `POBB Vickers Account` to $`50 000`.

* `/edit /investment /name POBB Vickers Account /newname OBOB Securities Account /amount 50000`

Changes the name of the account from `POBB Vickers Account` to `OBOB Securities Account` and the amount in the account
to $`50 000`.
...
[WARNING]
====
At least one of /desc, /category, /amount ,/frequency must be used.
====
