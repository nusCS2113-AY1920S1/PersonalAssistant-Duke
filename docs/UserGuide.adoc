...
.`/add /card /name POBB Tomorrow Card /limit 10000 /rebate 1.5` (Add Card Command)
image::AddCardCommandExample.png[caption="Figure : "]
...
.`/edit /card /name POBB Tomorrow Card /newname JunBank GoodVibes Card` (Edit Card Command)
image::EditCardCommandExample1.png[caption="Figure : "]
...
.`/edit /card /name POBB Tomorrow Card /limit 10000` (Edit Card Command)
image::EditCardCommandExample2.png[caption="Figure : "]
...
.`/edit /card /name POBB Tomorrow Card /limit 10000` (Edit Card Command)
image::EditCardCommandExample3.png[caption="Figure : "]
...
.`/delete /card /name POBB Tomorrow Card` (Delete Card Command)
image::DeleteCardCommandExample.png[caption="Figure : "]
...
.`/find /savings /name Jun` (Find Savings Account Command)
image::FindSavingsCommandExample.png[caption="Figure : "]
...
.`/find /investment /name Vickers` (Find Investment Account Command)
image::FindInvestmentCommandExample.png[caption="Figure : "]
...
.`/find /card /name POBB` (Find Card Command)
...
.`/find /bonds /name SSB /from DBB Vickers Account` (Find Bond Command)
image::FindBondCommandExample.png[caption="Figure : "]
...
.`/find /banktransaction /name JunBank Savings Account /desc bubble tea` (Find Bank Transaction Command)
image::FindBankTransactionCommandExample1.png[caption="Figure : "]
...
.`/find /banktransaction /name JunBank Savings Account /category food` (Find Bank Transaction Command)
image::FindBankTransactionCommandExample3.png[caption="Figure : "]
...
.`/find /banktransaction /name JunBank Savings Account /from 1/1/2019 /to 7/1/2019` (Find Bank Transaction Command)
image::FindBankTransactionCommandExample2.png[caption="Figure : "]
...
.`/find /banktransaction /name JunBank Savings Account /desc bubble tea /from 1/1/2019 /to 7/1/2019 /category food`
(Find Bank Transaction Command)
image::FindBankTransactionCommandExample4.png[caption="Figure : "]
...
.`/find /cardtransaction /name POBB Tomorrow Card /desc bubble tea` (Find Card Transaction Command)
image::FindCardTransactionCommandExample1.png[caption="Figure : "]
...
.`/find /cardtransaction /name POBB Tomorrow Card /category food` (Find Card Transaction Command)
image::FindCardTransactionCommandExample3.png[caption="Figure : "]
...
.`/find /cardtransaction /name POBB Tomorrow Card /from 1/1/2019 /to 7/1/2019` (Find Card Transaction Command)
image::FindCardTransactionCommandExample2.png[caption="Figure : "]
...
.`/find /cardtransaction /name POBB Tomorrow Card /desc bubble tea /from 1/1/2019 /to 7/1/2019 /category food` (Find
Card Transaction Command)
image::FindCardTransactionCommandExample4.png[caption="Figure : "]
...
.`/transfer /fund /from JunBank Savings Account /to POBB Savings Account /amount 500 /date 1/1/2019` (Transfer Fund
Command)
image::TransferfundCommandExample1.png[caption="Figure : "]
...
.`/transfer /fund /from DBB Vickers Account /to JunBank Savings Account /amount 250 /date 1/1/2019` (Transfer Fund
Command)
image::TransferfundCommandExample2.png[caption="Figure : "]
