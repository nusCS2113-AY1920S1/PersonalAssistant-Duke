...
.Successful edition of goal to link to savings account, untie from savings account and marking an
un-tracked goal as achieved.
ifdef::env-github[]
...
| *Finding recurring expenditure records within a specified savings account that match with the keyword
