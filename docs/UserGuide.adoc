...
Successful search of card after `/find /card`
...
.Successful search of bank transaction by description after `/find /banktransaction`
...
.Successful search of bank transaction by category after `/find /banktransaction`
...
.Successful search of bank transaction by date range after `/find /banktransaction`
...
.Successful search of card transaction by description after `/find /cardtransaction`
...
.Successful search of card transaction by category after `/find /cardtransaction`
...
.Successful search of card transaction by date range after `/find /cardtransaction`
...
.Successful search of card transaction by description, category and date range after `/find /cardtransaction`
...
.Successful search of recurring expenditure by description after `/find /recurbankexp`
...
.Successful search of recurring expenditure by category after `/find /recurbankexp`
...
.Successful search of recurring expenditure by description and category after `/find /recurbankexp`
