...
****
* Type `grade MOD_CODE LETTER_GRADE` into the command line, replacing `MODULECODE` with an actual module code, and `LETTER_GRADE` with the grade you received for that module.
...
Reschedule a CCA which is already added. +
