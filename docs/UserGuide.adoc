...
Panel will automatically select an intial location and the selected location will be glowing green in color. +
...
Once an event is selected, simply type in the new VENUE/DATE depending on what is currently highlighted. 
+
image::Ui.png[width="300" height="200"] 
+
