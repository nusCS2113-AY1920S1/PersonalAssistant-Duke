...
==== Sorting and printing the CCAs : `sort ccas f`

Sorts the cca list according to alphabetical order and prints the cca list. + 
Format: `sort ccas f` 

==== Sorting and printing the CCAs : `sort ccas r`

Sorts the cca list according to the reverse alphabetical order and prints the cca list. + 
Format: `sort ccas r` 
