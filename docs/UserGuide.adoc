...
.  Copy the file to the folder you want to use as the home folder for RIMS.
.  Double-click the file to start the app. The console should appear in a few seconds.
.  Type the command in the command box and press kbd:[Enter] to execute it. +
e.g. typing *`list`* and pressing kbd:[Enter] will show you a list of all the rooms and items with their statuses (booked/reserved/available).
