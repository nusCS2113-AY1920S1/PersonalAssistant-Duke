...
Adds a task that match the description given that will be repeated every week.
...
Adds a task that match the description given that can be confirmed at a later time.
