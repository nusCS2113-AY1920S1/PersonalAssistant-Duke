...
** If it is a todo task, you have to choose 1) if you want to edit the description or 2) if you want to edit the priority
- Then, enter the new DESCRIPTION or the new INDEX (priority) of the task
** If it is not a todo task, you have to choose 1) if you want to edit the description or 2) if you want to edit the date or 3) if you want to edit the priority
- Then, enter the new DESCRIPTION or the new DATE of the task or the new priority
...
* Edit the priority of the task 2 ( todo task)
- `edit`
- `2`
- `2`
- `INDEX` (priority)
